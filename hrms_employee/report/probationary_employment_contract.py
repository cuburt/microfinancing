...
class HRProbationaryEmploymentContract(models.TransientModel):
    _name = 'hr.probationary.employment.contract'
    ...
    def _print_report(self, data):
        return self.env['report'].sudo().get_action(self, 'hrms_employee.report_probationary_employment_template', data=data)


# PDF FILE REPORT
class HRProbationaryEmploymentContractReport(models.AbstractModel):
    _name = 'report.hrms_employee.report_probationary_employment_template'
    ...
    def render_html(self, docids, data):
        ...
        return self.env['report'].render('hrms_employee.report_probationary_employment_template', docargs)
